package diana.springframework.recipes.bootstrap;
...
import diana.springframework.recipes.model.Difficulty;
import diana.springframework.recipes.model.Ingredient;
import diana.springframework.recipes.model.Notes;
import diana.springframework.recipes.model.Recipe;
import diana.springframework.recipes.model.UnitOfMeasure;
import diana.springframework.recipes.repositories.CategoryRepository;
import diana.springframework.recipes.repositories.RecipeRepository;
import diana.springframework.recipes.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap
	...
	private List<Recipe> getRecipes() {
		...
		// get UOMs
		Optional<UnitOfMeasure> eachUomOptional = unitOfMeasureRepository
				.findByDescription("Each");
		...
		Optional<Category> mexicanCategoryOptional = categoryRepository
		...
		guacRecipe.addIngridient(
				new Ingredient("ripe avocados", new BigDecimal(2), eachUom));
		guacRecipe.addIngridient(new Ingredient("Kosher salt",
				new BigDecimal(".5"), teapoonUom));
		...
		guacRecipe.addIngridient(new Ingredient("freshly grated black pepper",
		...
		tacosRecipe.addIngridient(new Ingredient("Ancho Chili Powder",
				new BigDecimal(2), tableSpoonUom));
		tacosRecipe.addIngridient(
				new Ingredient("Dried Oregano", new BigDecimal(1), teapoonUom));
		tacosRecipe.addIngridient(
				new Ingredient("Dried Cumin", new BigDecimal(1), teapoonUom));
		...
		tacosRecipe.addIngridient(new Ingredient("Clove of Garlic, Choppedr",
				new BigDecimal(1), eachUom));
		tacosRecipe.getIngredients()
				.add(new Ingredient("finely grated orange zestr",
		...
		tacosRecipe.addIngridient(new Ingredient("boneless chicken thighs",
				new BigDecimal(4), tableSpoonUom));
		tacosRecipe.addIngridient(new Ingredient("small corn tortillasr",
				new BigDecimal(8), eachUom));
		tacosRecipe.addIngridient(new Ingredient("packed baby arugula",
				new BigDecimal(3), cupsUom));
		tacosRecipe.addIngridient(new Ingredient("medium ripe avocados, slic",
				new BigDecimal(2), eachUom));
		tacosRecipe.addIngridient(new Ingredient("radishes, thinly sliced",
				new BigDecimal(4), eachUom));
		tacosRecipe.addIngridient(new Ingredient("cherry tomatoes, halved",
				new BigDecimal(".5"), pintUom));
		tacosRecipe.addIngridient(new Ingredient("red onion, thinly sliced",
				new BigDecimal(".25"), eachUom));
		tacosRecipe.addIngridient(new Ingredient("Roughly chopped cilantro",
				new BigDecimal(4), eachUom));
		tacosRecipe.getIngredients()
				.add(new Ingredient("cup sour cream thinned with 1/4 cup milk",
						new BigDecimal(4), cupsUom));
		tacosRecipe.addIngridient(new Ingredient("lime, cut into wedges",
				new BigDecimal(4), eachUom));
